    ...
    var i = function() {
        ...
        u = o('<div class="dropdown-menu" role="list">', function(t, i) {
            var e = Array.isArray(i.items) ? i.items.map(function(t) {
                ...
                return '<a   href="#" ' + ('data-value="' + e + '"' + (void 0 !== n ? ' data-option="' + n + '"' : "")) + ' role="listitem" aria-label="' + e + '">' + o + "</a>"
            }).join("") : i.items;
        ...
        h = o('<div class="dropdown-menu note-check" role="list">', function(t, n) {
            var e = Array.isArray(n.items) ? n.items.map(function(t) {
                ...
                return '<a   href="#" data-value="' + e + '" role="listitem" aria-label="' + t + '">' + v(n.checkClassName) + " " + o + "</a>"
            }).join("") : n.items;
