...
(function(global, factory) {
    ...
    jQuery.extend({
        ...
        // jQuery.support is not used in Core but other turnos attach their
    ...
    // https://web.archive.org/web/20100324014747/http://blindsignals.com/turnos.php/2009/07/jquery-delay/
        ...
        propHooks: {
            tabIndex: {
                get: function(elem) {
                    ...
                    // https://web.archive.org/web/20141116233347/http://fluidTurnos.org/blog/2008/01/09/getting-setting-and-removing-tabindex-values-with-javascript/
